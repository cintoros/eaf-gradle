...
public class RentalServiceImpl implements RentalService {
    ...
    final private RentalRepository rentalRepo;
    ...
    public void deleteRental(Rental rental) {
        ...
        // add detached rental object to persistence context. This is necessary if the
        // property
        // spring.jpa.open-in-view=false is set.
        rental = rentalRepo.save(rental);
        // now user and movie are managed as well as they are accessed over a managed
        // entity.
