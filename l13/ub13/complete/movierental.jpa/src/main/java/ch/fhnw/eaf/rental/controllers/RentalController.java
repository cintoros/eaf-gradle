...
public class RentalController {
    ...
    // @Autowired
    public RentalController(RentalService rentalService, UserService userService, MovieService movieService) {
    ...
    @PostMapping
    @ApiResponses(value = { @ApiResponse(responseCode = "201", description = "Entity created"),
