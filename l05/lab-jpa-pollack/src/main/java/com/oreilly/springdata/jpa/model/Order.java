...
public class Order extends AbstractEntity {
	...
	public Order(Customer customer, Address shippingAddress, Address billingAddress) {
		Assert.notNull(customer, "[Assertion failed] - customer argument is required; it must not be null");
		Assert.notNull(shippingAddress, "[Assertion failed] - shippingAddress argument is required; it must not be null");
