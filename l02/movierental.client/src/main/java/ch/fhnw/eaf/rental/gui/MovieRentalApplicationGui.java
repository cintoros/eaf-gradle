...
import ch.fhnw.eaf.rental.gui.BusinessLogic.UserVisitor;
...
public class MovieRentalApplicationGui extends JFrame {
  ...
  public static final String DATA_BASE_ERR_MSG = "Error attempting to initialize database";
  ...
  private void initComponents() {
    ...
    versionNrLabel.setText(VERSION);
    ...
    homepageTextLabel.setText("http://www.fhnw.ch/imvs");
    ...
    // Rental Overview (openeed from a User by pressing "Get Rentals")
    ////////////////////////////////////////////////////////////////////////////////
    ...
    mainPane.addTab("Movies",
        new ImageIcon(getClass().getResource("/ch/fhnw/eaf/rental/gui/resources/movieLogo.png")),
    ...
    mainPane.addTab("Users",
        new ImageIcon(getClass().getResource("/ch/fhnw/eaf/rental/gui/resources/userLogo.png")),
    ...
    rentalsCRUDPanelLayout.setHorizontalGroup(rentalsCRUDPanelLayout
        ...
        .addGroup(GroupLayout.Alignment.TRAILING,
            rentalsCRUDPanelLayout.createSequentialGroup().addContainerGap().addComponent(refreshButton4)
                .addContainerGap(149, Short.MAX_VALUE).addComponent(deleteRentalsButton)
                .addContainerGap()));
    rentalsCRUDPanelLayout.setVerticalGroup(rentalsCRUDPanelLayout
        ...
        .addGroup(GroupLayout.Alignment.TRAILING, rentalsCRUDPanelLayout.createSequentialGroup()
            ...
            .addGap(18, 18, 18)
            .addGroup(rentalsCRUDPanelLayout.createParallelGroup(GroupLayout.Alignment.BASELINE)
                .addComponent(deleteRentalsButton)
                .addComponent(refreshButton4))
            .addContainerGap()));

    mainPane.addTab("Rentals",
        new ImageIcon(getClass().getResource("/ch/fhnw/eaf/rental/gui/resources/rentalLogo.png")),
  ...
  private void getUserButtonActionPerformed(ActionEvent evt) {
    ...
    if (nameDoNotMatchId) {
      JOptionPane.showMessageDialog(null, "User name does not match user id.");
      userIdForTextField.requestFocus();
    }
